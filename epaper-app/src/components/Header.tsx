...
export default function Header({
  ...
  return (
    <header className="w-[96%] lg:w-fit mx-auto bg-white/90 backdrop-blur-md rounded-3xl shadow-xl p-3 lg:px-6 lg:py-2.5 mb-4 flex flex-col lg:flex-row flex-wrap items-center justify-center gap-3 lg:gap-5 border border-slate-200/80 transition-all duration-300 relative z-30 font-sans mt-2">
      ...
      {/* 1. Date & Share */}
      <div className="flex w-full lg:w-auto items-center justify-center gap-2.5 order-1">
      ...
      {/* 2. Pages Navigation */}
      {totalPages > 0 && (
        <div className="flex w-full lg:w-auto items-center justify-center gap-1.5 overflow-x-auto py-1.5 px-3 bg-slate-100/80 rounded-2xl border border-slate-200 shadow-inner order-4 lg:order-2 mt-1 lg:mt-0">
      ...
      {/* 3. Logo */}
      <div className="flex w-full lg:w-auto items-center justify-center order-2 lg:order-3">
        <div className="h-[65px] w-[230px] bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex items-center justify-center p-1">
          <img 
      ...
      {/* 4. Visit & Admin */}
      <div className="flex w-full lg:w-auto items-center justify-center gap-2.5 order-3 lg:order-4">
